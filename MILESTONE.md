...
**Current item:** Phase 0 — shipped, awaiting PR merge.
...
| M0 | Feasibility spike: prober + workbook.xml sidecar (definedNames, calcPr) | All 97 corpus files load via xlnt; extraction verified vs openpyxl on 14-file sample; patch-vs-sideparse decision | **Done** — 97/97 load; 14/14 counts exact; 16,161-cell deep diff, 0 mismatches; decision: sidecar, no fork patch | this change |
| M1 | Full-corpus function/construct inventory; grammar freeze; lexer + parser + AST | 100% parse rate on all ~600k corpus formulas; pretty-print round-trip re-parses to identical AST | Pending | |
...
- 2026-07-09 — M0 implemented and verified in sandbox; ship pending.
